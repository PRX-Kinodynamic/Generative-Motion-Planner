"""
Configuration for 1D Double Integrator with PPO control.
...
from genMoPlan.utils.systems import DoubleIntegrator1DSystem
...
_default_system = DoubleIntegrator1DSystem.create(stride=1, history_length=1, horizon_length=31, variant="ppo")
