...
if __name__ == '__main__':
    ...
    parser.add_argument('--path_prefix', type=str, default='diffusion', help='Path prefix for logs')
    ...
    utils.visualize_trajectories(
        path.join('logs', args.dataset, args.path_prefix, args.exp_name),
        args.model_state_name,
        args.only_execute_next_step,
        sampling_limits=[(-1.5, 1.5), (-1.5, 1.5)],
        granularity=0.01
    )