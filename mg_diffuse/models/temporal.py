...
class ValueFunction(nn.Module):
    ...
    def __init__(
        ...
        ##
        self.mid_block1 = ResidualTemporalBlock(
            mid_dim, mid_dim_2, kernel_size=5, embed_dim=time_dim, horizon_length=horizon_length
        )
        self.mid_down1 = Downsample1d(mid_dim_2)
        horizon_length = horizon_length // 2
        ##
        self.mid_block2 = ResidualTemporalBlock(
            mid_dim_2, mid_dim_3, kernel_size=5, embed_dim=time_dim, horizon_length=horizon_length
        )
        self.mid_down2 = Downsample1d(mid_dim_3)
        horizon_length = horizon_length // 2
        ##
        fc_dim = mid_dim_3 * max(horizon_length, 1)
